##############################################################################
# This file is to implement Logistic regression on the different datasets    #
##############################################################################
import pandas as pd
...
columns = ['admission_location', 'discharge_location',
           'insurance', 'marital_status', 'los', 'readmission_90', 'los_ED',
           'no_ED_admissions', 'gender', 'age_group','icd9_code']
categorical = ['admission_location', 'discharge_location',
           'insurance', 'marital_status','icd9_code','age_group' ]

from tableone import TableOne
table = TableOne(raw, columns=columns, categorical=categorical,limit={"icd9_code": 10})
print(table.tabulate(tablefmt="github"))
table.to_excel(r'C:\Users\mas082\OneDrive - UiT Office 365\Desktop\VS_Code\ICD_Modularity_Paper\tableone_output.xlsx')
##########################
#   1. Raw dataset       #
##########################
#####################################
...
###########################################
# Implementing Logistic regression on Raw
###########################################
...
# ROC curve
#--------------------
y_pred_proba_raw = log_reg_raw.predict_proba(X_raw_clean_test)[::,1]
...
###############################################
y_pred_raw_CI= np.array(y_pred_proba_raw)
...
# df['icd_gruppe'] = df['icd_gruppe'].astype(str)
...
# ROC curve
#--------------------
y_pred_proba_R1 = log_reg_R1.predict_proba(X_R1_clean_test)[::,1]
...
# Calculating CI 95% for the metrics 
###############################################
y_pred_R1_CI= np.array(y_pred_proba_R1)
...
###########################################
# Implementing Logistic regression on R08
###########################################
log_reg_R08 = LogisticRegression(random_state=0, solver='liblinear')
log_reg_R08.fit(X_R08_clean_train, y_R08_train)

y_pred_log_reg_R08 = log_reg_R08.predict(X_R08_clean_test)
print("Accuracy of logistic regression R08:", metrics.accuracy_score(y_R08_test, y_pred_log_reg_R08))
print("Precision:",metrics.precision_score(y_R08_test, y_pred_log_reg_R08))
print("Recall:",metrics.recall_score(y_R08_test, y_pred_log_reg_R08))
print(classification_report(y_R08_test, y_pred_log_reg_R08))

# ROC curve
#--------------------
y_pred_proba_R08 = log_reg_R08.predict_proba(X_R08_clean_test)[::,1]
fpr, tpr, _ = metrics.roc_curve(y_R08_test,  y_pred_proba_R08)
AUC = metrics.roc_auc_score(y_R08_test, y_pred_proba_R08)
plt.plot(fpr,tpr,label="Logistic Regression R08, AUC="+str(AUC))
plt.legend(loc=4)
plt.show()

# Calculating CI 95% for the metrics 
###############################################
y_pred_R08_CI= np.array(y_pred_proba_R08)
...
# Classification report to calculate f1-score 
#---------------------------------------------------
cm_R08 = metrics.confusion_matrix(y_R08_test, y_pred_log_reg_R08)
...
ax.xaxis.set_label_position("top")
plt.tight_layout()
plt.title('Confusion matrix LR_R08', y=1.1)
plt.ylabel('Actual label')
plt.xlabel('Predicted label')
...
###########################################
# Implementing Logistic regression on R06
###########################################
log_reg_R06 = LogisticRegression(random_state=0, solver='liblinear')
log_reg_R06.fit(X_R06_clean_train, y_R06_train)

y_pred_log_reg_R06 = log_reg_R06.predict(X_R06_clean_test)
print("Accuracy of logistic regression R06:", metrics.accuracy_score(y_R06_test, y_pred_log_reg_R06))
print("Precision:",metrics.precision_score(y_R06_test, y_pred_log_reg_R06))
print("Recall:",metrics.recall_score(y_R06_test, y_pred_log_reg_R06))
print(classification_report(y_R06_test, y_pred_log_reg_R06))

# ROC curve
#--------------------
y_pred_proba_R06 = log_reg_R06.predict_proba(X_R06_clean_test)[::,1]
fpr, tpr, _ = metrics.roc_curve(y_R06_test,  y_pred_proba_R06)
AUC = metrics.roc_auc_score(y_R06_test, y_pred_proba_R06)
plt.plot(fpr,tpr,label="Logistic Regression R06, AUC="+str(AUC))
plt.legend(loc=4)
plt.show()

# Calculating CI 95% for the metrics 
###############################################
y_pred_R06_CI= np.array(y_pred_proba_R06)
...
# Classification report to calculate f1-score 
#---------------------------------------------------
cm_R06 = metrics.confusion_matrix(y_R06_test, y_pred_log_reg_R06)
...
ax.xaxis.set_label_position("top")
plt.tight_layout()
plt.title('Confusion matrix LR_R06', y=1.1)
plt.ylabel('Actual label')
plt.xlabel('Predicted label')
...
###########################################
# Implementing Logistic regression on R05
###########################################
log_reg_R05 = LogisticRegression(random_state=0, solver='liblinear')
log_reg_R05.fit(X_R05_clean_train, y_R05_train)

y_pred_log_reg_R05 = log_reg_R05.predict(X_R05_clean_test)
print("Accuracy of logistic regression R05:", metrics.accuracy_score(y_R05_test, y_pred_log_reg_R05))
print("Precision:",metrics.precision_score(y_R05_test, y_pred_log_reg_R05))
print("Recall:",metrics.recall_score(y_R05_test, y_pred_log_reg_R05))
print(classification_report(y_R05_test, y_pred_log_reg_R05))

# ROC curve
#--------------------
y_pred_proba_R05 = log_reg_R05.predict_proba(X_R05_clean_test)[::,1]
fpr, tpr, _ = metrics.roc_curve(y_R05_test,  y_pred_proba_R05)
AUC = metrics.roc_auc_score(y_R05_test, y_pred_proba_R05)
plt.plot(fpr,tpr,label="Logistic Regression R05, AUC="+str(AUC))
plt.legend(loc=4)
plt.show()
...
# Calculating CI 95% for the metrics 
###############################################
y_pred_R05_CI= np.array(y_pred_proba_R05)
...
# Classification report to calculate f1-score 
#---------------------------------------------------
cm_R05 = metrics.confusion_matrix(y_R05_test, y_pred_log_reg_R05)
...
ax.xaxis.set_label_position("top")
plt.tight_layout()
plt.title('Confusion matrix LR_R05', y=1.1)
plt.ylabel('Actual label')
plt.xlabel('Predicted label')
...
###########################################
# Implementing Logistic regression R01
###########################################
log_reg_R01 = LogisticRegression(random_state=0, solver='liblinear')
log_reg_R01.fit(X_R01_clean_train, y_R01_train)

y_pred_log_reg_R01 = log_reg_R01.predict(X_R01_clean_test)
print("Accuracy of logistic regression R01:", metrics.accuracy_score(y_R01_test, y_pred_log_reg_R01))
print("Precision:",metrics.precision_score(y_R01_test, y_pred_log_reg_R01))
print("Recall:",metrics.recall_score(y_R01_test, y_pred_log_reg_R01))
print(classification_report(y_R01_test, y_pred_log_reg_R01))

# ROC curve
#--------------------
y_pred_proba_R01 = log_reg_R01.predict_proba(X_R01_clean_test)[::,1]
fpr, tpr, _ = metrics.roc_curve(y_R01_test,  y_pred_proba_R01)
AUC = metrics.roc_auc_score(y_R01_test, y_pred_proba_R01)
plt.plot(fpr,tpr,label="Logistic Regression R01, AUC="+str(AUC))
plt.legend(loc=4)
plt.show()

# Calculating CI 95% for the metrics 
###############################################
y_pred_R01_CI= np.array(y_pred_proba_R01)
...
# Classification report to calculate f1-score 
#---------------------------------------------------
cm_R01 = metrics.confusion_matrix(y_R01_test, y_pred_log_reg_R01)
...
ax.xaxis.set_label_position("top")
plt.tight_layout()
plt.title('Confusion matrix LR_R01', y=1.1)
plt.ylabel('Actual label')
plt.xlabel('Predicted label')
...
###########################################
# Implementing Logistic regression on R001
###########################################
log_reg_R001 = LogisticRegression(random_state=0, solver='liblinear')
log_reg_R001.fit(X_R001_clean_train, y_R001_train)

y_pred_log_reg_R001 = log_reg_R001.predict(X_R001_clean_test)
print("Accuracy of logistic regression R001:", metrics.accuracy_score(y_R001_test, y_pred_log_reg_R001))
print("Precision:",metrics.precision_score(y_R001_test, y_pred_log_reg_R001))
print("Recall:",metrics.recall_score(y_R001_test, y_pred_log_reg_R001))
print(classification_report(y_R001_test, y_pred_log_reg_R001))

# ROC curve
#--------------------
y_pred_proba_R001 = log_reg_R001.predict_proba(X_R001_clean_test)[::,1]
fpr, tpr, _ = metrics.roc_curve(y_R001_test,  y_pred_proba_R001)
AUC = metrics.roc_auc_score(y_R001_test, y_pred_proba_R001)
plt.plot(fpr,tpr,label="Logistic Regression R001, AUC="+str(AUC))
plt.legend(loc=4)
plt.show()
...
# Calculating CI 95% for the metrics 
###############################################
y_pred_R001_CI= np.array(y_pred_proba_R001)
...
# Classification report to calculate f1-score 
#---------------------------------------------------
cm_R001 = metrics.confusion_matrix(y_R001_test, y_pred_log_reg_R001)
...
ax.xaxis.set_label_position("top")
plt.tight_layout()
plt.title('Confusion matrix LR_R001', y=1.1)
plt.ylabel('Actual label')
plt.xlabel('Predicted label')
...
###########################################
# Implementing Logistic regression on CCS
###########################################
log_reg_CCS = LogisticRegression(random_state=0, solver='liblinear')
log_reg_CCS.fit(X_CCS_clean_train, y_CCS_train)

y_pred_log_reg_CCS = log_reg_CCS.predict(X_CCS_clean_test)
print("Accuracy of logistic regression CCS:", metrics.accuracy_score(y_CCS_test, y_pred_log_reg_CCS))
print("Precision:",metrics.precision_score(y_CCS_test, y_pred_log_reg_CCS))
print("Recall:",metrics.recall_score(y_CCS_test, y_pred_log_reg_CCS))
print(classification_report(y_CCS_test, y_pred_log_reg_CCS))

# ROC curve
#--------------------
y_pred_proba_CCS = log_reg_CCS.predict_proba(X_CCS_clean_test)[::,1]
fpr, tpr, _ = metrics.roc_curve(y_CCS_test,  y_pred_proba_CCS)
AUC = metrics.roc_auc_score(y_CCS_test, y_pred_proba_CCS)
plt.plot(fpr,tpr,label="Logistic Regression CCS, AUC="+str(AUC))
plt.legend(loc=4)
plt.show()

# Calculating CI 95% for the metrics 
###############################################
y_pred_CCS_CI= np.array(y_pred_proba_CCS)
...
# Classification report to calculate f1-score 
#---------------------------------------------------
cm_CCS = metrics.confusion_matrix(y_CCS_test, y_pred_log_reg_CCS)
...
ax.xaxis.set_label_position("top")
plt.tight_layout()
plt.title('Confusion matrix LR_CCS', y=1.1)
plt.ylabel('Actual label')
plt.xlabel('Predicted label')
...
####################################################
# Implementing Logistic regression on ICD_highest
###################################################
log_reg_ICD_HIGHEST = LogisticRegression(random_state=0, solver='liblinear')
log_reg_ICD_HIGHEST.fit(X_ICD_HIGHEST_clean_train, y_ICD_HIGHEST_train)

y_pred_log_reg_ICD_HIGHEST = log_reg_ICD_HIGHEST.predict(X_ICD_HIGHEST_clean_test)
print("Accuracy of logistic regression ICD_HIGHEST:", metrics.accuracy_score(y_ICD_HIGHEST_test, y_pred_log_reg_ICD_HIGHEST))
print("Precision:",metrics.precision_score(y_ICD_HIGHEST_test, y_pred_log_reg_ICD_HIGHEST))
print("Recall:",metrics.recall_score(y_ICD_HIGHEST_test, y_pred_log_reg_ICD_HIGHEST))
print(classification_report(y_ICD_HIGHEST_test, y_pred_log_reg_ICD_HIGHEST))

# ROC curve
#--------------------
y_pred_proba_ICD_HIGHEST = log_reg_ICD_HIGHEST.predict_proba(X_ICD_HIGHEST_clean_test)[::,1]
...
plt.plot(fpr,tpr,label="Logistic Regression ICD_HIGHEST, AUC="+str(AUC))
plt.legend(loc=4)
plt.show()
...
# Calculating CI 95% for the metrics 
###############################################
y_pred_ICD_HIGHEST_CI= np.array(y_pred_proba_ICD_HIGHEST)
...
# Classification report to calculate f1-score 
#---------------------------------------------------
cm_ICD_HIGHEST = metrics.confusion_matrix(y_ICD_HIGHEST_test, y_pred_log_reg_ICD_HIGHEST)
...
ax.xaxis.set_label_position("top")
plt.tight_layout()
plt.title('Confusion matrix LR_ICD_HIGHEST', y=1.1)
plt.ylabel('Actual label')
plt.xlabel('Predicted label')

# Invistigate feature importance using RF
#--------------------------------------------
from sklearn.ensemble import RandomForestClassifier
random_forest = RandomForestClassifier(random_state=42)
# get the model parameters
random_forest.fit(X_R08_clean_train, y_R08_train)
y_pred_rf = random_forest.predict(X_R08_clean_test)
random_forest.feature_importances_
feature_importances = pd.Series(random_forest.feature_importances_, index=X2_R08.columns)
feature_importances.nlargest(25).plot(kind='barh')
plt.title("Feature importance R08")
plt.show() 

######################################################################################
#  Testing if there is a significant difference between ROC AUC of these models
######################################################################################
...
def permutation_test_between_clfs(y_test, pred_proba_1, pred_proba_2, nsamples=1000):
    ...
    return observed_difference, np.mean(auc_differences >= observed_difference) # this won't work here because the y-test is different according to each encoding approach

## DELONG's test can be used to copmare AUCs too
##################################################
from scipy.stats import ttest_rel

# Assuming you have already calculated the bootstrapped AUC values and stored them in lists:
# bootstrapped_aucs_raw, bootstrapped_aucs_R1, bootstrapped_aucs_CCS, bootstrapped_aucs_ICD_HIGHEST
# Perform paired t-test between raw and R1 datasets
from scipy.stats import ttest_rel

# Assuming you have already calculated the bootstrapped AUC values and stored them in a dictionary:
bootstrapped_aucs = {
    "raw": bootstrapped_aucs_raw,
    "R1": bootstrapped_aucs_R1,
    "CCS": bootstrapped_aucs_CCS,
    "ICD_HIGHEST": bootstrapped_aucs_ICD_HIGHEST
}

# Perform pairwise comparisons using paired t-tests
datasets = list(bootstrapped_aucs.keys())
for i, dataset1 in enumerate(datasets):
    for j, dataset2 in enumerate(datasets):
        if i < j:  # To ensure we don't repeat comparisons or compare a dataset with itself
            t_stat, p_val = ttest_rel(bootstrapped_aucs[dataset1], bootstrapped_aucs[dataset2])
            print(f"Paired t-test between {dataset1} and {dataset2} datasets:")
            print(f"t-statistic = {t_stat}, p-value = {p_val}")
            
            # Interpretation
            alpha = 0.05
            if p_val < alpha:
                print(f"There is a statistically significant difference between the AUC values of the {dataset1} and {dataset2} datasets.")
            else:
                print(f"There is no statistically significant difference between the AUC values of the {dataset1} and {dataset2} datasets.")
            print("-" * 50)  # For clearer separation between results
...
for i, dataset1 in enumerate(datasets):
    for j, dataset2 in enumerate(datasets):
        if i < j:  # To ensure we don't repeat comparisons or compare a dataset with itself
            w_stat, p_val = wilcoxon(bootstrapped_aucs[dataset1], bootstrapped_aucs[dataset2])
            print(f"Wilcoxon signed-rank test between {dataset1} and {dataset2} datasets:")
...
# Calculate the median difference between R1 and ICD_HIGHEST
median_difference = np.median(np.array(bootstrapped_aucs['R1']) - np.array(bootstrapped_aucs['ICD_HIGHEST']))

# Determine which dataset has a higher AUC
if median_difference > 0:
    print("The bootstrapped AUC values for R1 are typically higher than those for ICD_HIGHEST.")
elif median_difference < 0:
    print("The bootstrapped AUC values for ICD_HIGHEST are typically higher than those for R1.")
else:
    print("The median bootstrapped AUC values for R1 and ICD_HIGHEST are the same.")
...
# Import all datasets
#------------------------
raw = pd.read_stata("C:/Users/mas082/OneDrive - UiT Office 365/Desktop/ICD_Modularit_Paper/Final_Datasets_To_Implement_Models/Selected_Variables_Final_Model_90_days.dta")

# Dropping id variables (assuming they are named 'subject_id' and 'hadm_id' in your dataset)
#-------------------------
raw.drop(['subject_id', 'hadm_id'], axis=1, inplace=True)

# Ensure 'age_group' and 'gender' are of type string for consistency in encoding
#--------------------------------------------------------------------------------
raw['age_group'] = raw['age_group'].astype(str)
raw['gender'] = raw['gender'].astype(str)

# Splitting data into X (features) and y (target)
#-----------------------------
X = raw.drop('readmission_90', axis=1)
y = raw['readmission_90']

# Splitting X into numerical and categorical features
#-----------------------------------------------------
X_numerical = X[['los', 'los_ED', 'no_ED_admissions']].copy()
X_categorical = X.select_dtypes(include=['object', 'int16', 'int8'])
...
#-----------------------------------------------------
X_combined = pd.concat([X_numerical.reset_index(drop=True), X_categorical_encoded.reset_index(drop=True)], axis=1)

# Splitting into train and test sets while stratifying y to maintain class distribution
#----------------------------------------------------------------------------------------
X_train, X_test, y_train, y_test = train_test_split(X_combined, y, test_size=0.3, random_state=0, stratify=y)

# Standardizing numerical features
#----------------------------------
scaler = StandardScaler()
X_train_numerical_scaled = scaler.fit_transform(X_train[['los', 'los_ED', 'no_ED_admissions']])
X_test_numerical_scaled = scaler.transform(X_test[['los', 'los_ED', 'no_ED_admissions']])

# Replacing original numerical columns with scaled versions
for col, col_data in zip(['los', 'los_ED', 'no_ED_admissions'], X_train_numerical_scaled.T):
    X_train[col] = col_data
for col, col_data in zip(['los', 'los_ED', 'no_ED_admissions'], X_test_numerical_scaled.T):
    X_test[col] = col_data
...
# ROC curve
#----------
y_pred_proba_raw = log_reg.predict_proba(X_test)[::,1]
fpr, tpr, _ = metrics.roc_curve(y_test,  y_pred_proba_raw)
AUC = metrics.roc_auc_score(y_test, y_pred_proba_raw)
plt.plot(fpr,tpr,label="Logistic Regression Raw, AUC="+str(AUC))
plt.legend(loc=4)
plt.show()
